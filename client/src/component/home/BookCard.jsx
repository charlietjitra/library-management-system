...
const BookCard = ({book}) => {
  return (
    ...
    >
        <div className="p-6">
        <h3 className="mb-2 text-xl font-semibold">{book.bookName}</h3>
        <div className="space-y-2 text-gray-600">
            ...
            <p className="flex items-center">
            <span className="w-24 font-medium">Country:</span>
            <span>{book.country}</span>
            </p>
        </div>
        </div>
        
        <div className="flex justify-end px-6 py-4 space-x-4 border-t bg-gray-50">
        <Link 
